...
def _default_reminder_config():
    ...
    return {
        ...
        "rules": [
            ...
            {"id": "aa-feilixiao", "label": "资产配置部研究组 · 费立孝", "mode": "person", "target": 1,
             "userIds": ["feilixiao"]},
            {"id": "aa-zhangqingchang", "label": "资产配置部研究组 · 张庆昌", "mode": "person", "target": 1,
             "userIds": ["zhangqingchang"]},
            {"id": "aa-wanghui", "label": "资产配置部研究组 · 王辉", "mode": "person", "target": 1,
             "userIds": ["wanghui"]},
            {"id": "aa-liushengyao", "label": "资产配置部研究组 · 刘圣尧", "mode": "person", "target": 1,
             "userIds": ["liushengyao"]},
            {"id": "aa-zongshaohui", "label": "资产配置部研究组 · 宗韶晖", "mode": "person", "target": 1,
             "userIds": ["zongshaohui"]},
            {"id": "aa-songlingfeng", "label": "资产配置部研究组 · 宋凌峰", "mode": "person", "target": 1,
